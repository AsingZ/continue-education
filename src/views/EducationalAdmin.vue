	...
	<el-container style="position: absolute;top: 0px;bottom: 0px;width: 100%; height: 100%; border: 1px solid #eee ">
		<el-aside width="200px" style="background-color: rgb(238, 241, 246);">
			<el-menu router="true" default-active="/admin/user">
				<el-menu-item index="/educationalAdmin/user">
					<i class="el-icon-setting"></i>
					<template #title>用户管理</template>
				</el-menu-item>
				<el-menu-item index="/educationalAdmin/course">
					<i class="el-icon-setting"></i>
					<template #title>课程管理</template>
				</el-menu-item>
				<el-menu-item index="/educationalAdmin/department">
					<i class="el-icon-setting"></i>
					<template #title>院系信息管理</template>
				</el-menu-item>
			</el-menu>
		</el-aside>
